...
s1.async=true;
s1.src='https://embed.tawk.to/6466257ead80445890edb462/1h0ng4tqq';
s1.charset='UTF-8';
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.php">E-Tech</a></div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="teacher text-center">
              <img src="images/person_01.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Mahim Pratap Rana</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="teacher text-center">
              <img src="images/person_02.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Devesh Kumar Mandal</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="teacher text-center">
              <img src="images/person_03.jpg" alt="Image" class="img-fluid w-50 rounded-circle mx-auto mb-4">
              <div class="py-2">
                <h3 class="text-black">Prajwal Babu Giri</h3>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-md-8 text-center testimony">
            <img src="images/person_04.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
            <h3 class="mb-4">Mahesh Chapagein</h3>
            <blockquote>
              <p>&ldquo; I was struggling with my studies but it all changed when I learned about E-Tech, I'm now a senior software engineer making a 6 figure salary per year.This website is a real game changer. &rdquo;</p>
            </blockquote>
          </div>
        </div>
      </div>
    ...
    <footer class="footer-section bg-white">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>Subscribe</h3>
            <p>Keep yourself up to date and receive all kind of news about E-Tech.</p>
